...
import { PreSalesStatusTagComponent } from '../../../pre-sales/components/pre-sales-status-tag.component';
import { MatTooltip } from '@angular/material/tooltip';
import { MatSort, MatSortHeader, Sort } from '@angular/material/sort';
import { PreSaleImportHistoryResponseDto } from '../../../pre-sales/models/pre-sales.types';
import { QueryCategoryPipe } from '../../../pre-sales/pipes/query-category.pipe';
import { QueryTypePipe } from '../../../pre-sales/pipes/query-type.pipe';
import { TableColumnDef } from 'app/layout/common/table-column-management/table-column-management.component';

export const PRE_SALE_QUERIES_STATUS_TABLE_COLUMNS: TableColumnDef[] = [
...
@Component({
  selector: 'app-pre-sale-queries-status-table',
      ...
      <div class="grow flex">
        ...
        <mat-table [dataSource]="dataSet" matSort (matSortChange)="onSortChange($event)" class="grow">
          ...
          <ng-container matColumnDef="menu">
            <mat-header-cell *matHeaderCellDef class="min-w-20"></mat-header-cell>
            <mat-cell *matCellDef="let element" class="min-w-20 justify-end">
...
export class PreSaleQueriesStatusTableComponent {
  protected readonly visibleColumns = input<string[]>(PRE_SALE_QUERIES_STATUS_TABLE_COLUMNS.map((c) => c.key));
  protected readonly queries = input<PreSaleImportHistoryResponseDto[]>();
