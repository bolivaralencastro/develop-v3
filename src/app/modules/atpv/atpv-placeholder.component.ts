...
@Component({
  ...
  template: `
    ...
    <div class="mx-4 mb-4 flex flex-col items-center justify-center bg-card rounded-lg shadow grow gap-4 py-16">
      <mat-icon class="w-16 h-16 text-gray-200" svgIcon="mat_outline:social_distance"></mat-icon>
...
export class AtpvPlaceholderComponent implements OnInit {
  private readonly route = inject(ActivatedRoute);
  protected title = 'ATPV';

  ngOnInit() {
    this.title = this.route.snapshot.data['title'] ?? 'ATPV';
  }
}
