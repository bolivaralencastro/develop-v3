...
const MOCK: Record<ConsultaDetalheType, ConsultaDetalheDto[]> = {
  ...
  RECALL: [
    { id: '1', placa: 'RUO7A43', renavam: '1303556844', chassi: '8AP359AFDNU217106', estado: 'MG', status: 'BLOQUEADO', recall: '8AP2022017-8498 RECALL TUBULACAO DE COMBUSTIVEL, SERVICO GRATUITO CASO JA TENHA REALIZADO O RECALL FAVOR DESCONSIDERAR ESTA MENSAGEM', descricaoRecall: 'SEU VEICULO ESTA BLOQUEADO PARA LICENCIAMENTO ANUAL, DEVIDO PENDENCIA DE REALIZACAO DE RECALL, CONFORME CODIGO BRASILEIRO DE TRANSITO. CONTATE SUA CONCESSIONARIA FIAT PARA AGENDAMENTO E REALIZACAO GRATUITA DOS SERVICOS NECESSARIOS', dataRegistroRecall: '12/10/2022', dataLimiteRecall: '12/10/2023', situacaoRecall: 'VENCIDO' },
    { id: '2', placa: 'RUA9A09', renavam: '1295518349', chassi: '9BD358AFNNYM01520', estado: 'MG', status: 'BLOQUEADO', recall: '9BD2022016-8498 RECALL TUBULACAO DE COMBUSTIVEL, SERVICO GRATUITO CASO JA TENHA REALIZADO O RECALL FAVOR DESCONSIDERAR ESTA MENSAGEM', descricaoRecall: 'SEU VEICULO ESTA BLOQUEADO PARA LICENCIAMENTO ANUAL, DEVIDO PENDENCIA DE REALIZACAO DE RECALL, CONFORME CODIGO BRASILEIRO DE TRANSITO. CONTATE SUA CONCESSIONARIA FIAT PARA AGENDAMENTO E REALIZACAO GRATUITA DOS SERVICOS NECESSARIOS', dataRegistroRecall: '12/13/2022', dataLimiteRecall: '12/13/2023', situacaoRecall: 'VENCIDO' },
    { id: '3', placa: 'TDF1J80', renavam: '1417983610', chassi: '9BD281AJHSYG48999', estado: 'MG', status: 'ALERTA', recall: '9BD2025002-8850 VERIFICACAO E SE NECESSARIO A SUBSTITUICAO DO PEDAL DO ACELERADOR.', descricaoRecall: 'POSSIBILIDADE DE MAU CONTATO DO CONECTOR ELETRICO DO PEDAL ACELERADOR QUE PODERA OCASIONAR A PERDA DA ACELERACAO COM VEICULO EM MOVIMENTO, PODENDO OCORRER ACIDENTES COM DANOS MATERIAIS, FISICOS OU ATE MESMO FATAIS AOS OCUPANTES DO VEICULO E OU TERCEIROS', dataRegistroRecall: '4/14/2025', dataLimiteRecall: '4/14/2026', situacaoRecall: 'ATE 4 MESES' },
    { id: '4', placa: 'EHE9C86', renavam: '1337233320', chassi: '9BWAH5BZ3PT605148', estado: 'SP', status: 'ALERTA', recall: '9BD2025002-8850 VERIFICACAO E SE NECESSARIO A SUBSTITUICAO DO PEDAL DO ACELERADOR.', descricaoRecall: 'POSSIBILIDADE DE MAU CONTATO DO CONECTOR ELETRICO DO PEDAL ACELERADOR QUE PODERA OCASIONAR A PERDA DA ACELERACAO COM VEICULO EM MOVIMENTO, PODENDO OCORRER ACIDENTES COM DANOS MATERIAIS, FISICOS OU ATE MESMO FATAIS AOS OCUPANTES DO VEICULO E OU TERCEIROS', dataRegistroRecall: '4/14/2025', dataLimiteRecall: '4/14/2026', situacaoRecall: 'ATE 4 MESES' },
    { id: '5', placa: 'SDT6I30', renavam: '1318572280', chassi: '93YRBB002PJ360128', estado: 'PR', status: 'ALERTA', recall: '93Y2025009-0EHN', descricaoRecall: 'Suporte do eixo traseiro', dataRegistroRecall: '9/8/2025', dataLimiteRecall: '9/8/2026', situacaoRecall: 'MAIS DE 4 MESES' },
    { id: '6', placa: 'SDU4J72', renavam: '1319711690', chassi: '93YRBB001PJ354689', estado: 'PR', status: 'ALERTA', recall: '93Y2025009-0EHN', descricaoRecall: 'Suporte do eixo traseiro', dataRegistroRecall: '9/8/2025', dataLimiteRecall: '9/8/2026', situacaoRecall: 'MAIS DE 4 MESES' },
  ...
  GNV: [
    { id: '1', placa: 'SEG6A92', renavam: '1342955312', chassi: '9BM958471PB314037', estado: 'PR', status: 'BLOQUEADO', ultimoLaudoGnv: '8/28/2024', prazoRegularizacaoGnv: '8/28/2025', situacaoGnv: 'VENCIDO' },
    { id: '2', placa: 'SEO2G15', renavam: '1352105834', chassi: '93ZS62VTZP8841041', estado: 'PR', status: 'BLOQUEADO', ultimoLaudoGnv: '9/18/2024', prazoRegularizacaoGnv: '9/18/2025', situacaoGnv: 'VENCIDO' },
    { id: '3', placa: 'SER8B43', renavam: '1355860919', chassi: '93ZA01RF0P8955410', estado: 'SP', status: 'BLOQUEADO', ultimoLaudoGnv: '9/19/2024', prazoRegularizacaoGnv: '9/19/2025', situacaoGnv: 'VENCIDO' },
    { id: '4', placa: 'SWN2B68', renavam: '1383137096', chassi: '9BHCP41BBSP575205', estado: 'SP', status: 'ALERTA', ultimoLaudoGnv: '4/4/2025', prazoRegularizacaoGnv: '4/4/2026', situacaoGnv: 'ATE 4 MESES' },
    { id: '5', placa: 'SSX4B67', renavam: '1379134967', chassi: '9BHCP41BBRP557230', estado: 'SP', status: 'ALERTA', ultimoLaudoGnv: '4/9/2025', prazoRegularizacaoGnv: '4/9/2026', situacaoGnv: 'ATE 4 MESES' },
    { id: '6', placa: 'SER8B56', renavam: '1355855745', chassi: '93ZA01RF0P8955353', estado: 'SP', status: 'ALERTA', ultimoLaudoGnv: '4/9/2025', prazoRegularizacaoGnv: '4/9/2026', situacaoGnv: 'ATE 4 MESES' },
    { id: '7', placa: 'RHV9I16', renavam: '1293503859', chassi: '9BM958134MB233419', estado: 'SP', status: 'ALERTA', ultimoLaudoGnv: '7/18/2025', prazoRegularizacaoGnv: '7/18/2026', situacaoGnv: 'MAIS DE 4 MESES' },
    { id: '8', placa: 'RHV9I13', renavam: '1293505452', chassi: '9BM958134MB233049', estado: 'SP', status: 'ALERTA', ultimoLaudoGnv: '7/30/2025', prazoRegularizacaoGnv: '7/30/2026', situacaoGnv: 'MAIS DE 4 MESES' },
    { id: '9', placa: 'RHV9I20', renavam: '1293502160', chassi: '9BM958134MB224763', estado: 'SP', status: 'ALERTA', ultimoLaudoGnv: '7/30/2025', prazoRegularizacaoGnv: '7/30/2026', situacaoGnv: 'MAIS DE 4 MESES' },
    { id: '10', placa: 'SEF6D88', renavam: '1341349613', chassi: '93ZS62VTZP8841027', estado: 'PR', status: 'ALERTA', ultimoLaudoGnv: '1/27/2026', prazoRegularizacaoGnv: '1/27/2027', situacaoGnv: 'MAIS DE 4 MESES' },
  ],
  GRAVAME: [
