...
import { APP_INITIALIZER, EnvironmentProviders, importProvidersFrom, inject, provideEnvironmentInitializer, Provider } from '@angular/core';
...
import { FUSE_API_CONFIG, FUSE_CONFIG } from '@fuse/services/config/config.constants';
...
export const provideFuse = (config: FuseProviderConfig): Array<Provider | EnvironmentProviders> => {
  ...
  const providers: Array<Provider | EnvironmentProviders> = [
    ...
    {
      provide: FUSE_API_CONFIG,
      useValue: config?.mockApi ?? {},
    },
  ...
  // Mock Api services // TODO: Remove with Fuse mock API's, this is used to provide the services to the injector
